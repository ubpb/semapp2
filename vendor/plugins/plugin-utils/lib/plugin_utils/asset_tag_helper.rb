  ...
  module PluginUtils
    module AssetTagHelper
      ...
      def stylesheet_link_tag_with_engine_additions(*sources)
        stylesheet_link_tag_without_engine_additions(*Provideal::PluginUtils::AssetTagHelper.pluginify_sources("stylesheets", *sources))
      end
      ...
      def javascript_include_tag_with_engine_additions(*sources)
        javascript_include_tag_without_engine_additions(*Provideal::PluginUtils::AssetTagHelper.pluginify_sources("javascripts", *sources))
      end
      ...
      def image_path_with_engine_additions(source, options={})
        ...
        source = Provideal::PluginUtils::AssetTagHelper.plugin_asset_path(options["plugin"], "images", source) if options["plugin"]
      ...
      def image_tag_with_engine_additions(source, options={})
        options.stringify_keys!
        if options["plugin"]
          source = Provideal::PluginUtils::AssetTagHelper.plugin_asset_path(options["plugin"], "images", source)
